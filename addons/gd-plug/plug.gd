...
func show_syntax():
	...
	var actions = {
		...
		"install, update": "Install or update (to latest version if not freezed) \"plugged\" plugins based on plug.gd, or uninstall \"unplugged\" plugins",
